          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-end -mt-12 sm:-mt-16">
              ...
              {profileData?.profilePicture ? (
                <img src={profileData.profilePicture} alt={fullName} className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-white object-cover shadow-md shrink-0" />
              ) : (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="border-transparent shadow-soft bg-white">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                ...
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Gender</p>
                  <p className="font-medium text-surface-900">{profileData?.gender || 'Not specified'}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Marital Status</p>
                  <p className="font-medium text-surface-900">{profileData?.maritalStatus || 'Not specified'}</p>
                </div>
          ...
          <Card className="border-transparent shadow-soft bg-white">
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                ...
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Reporting To</p>
                  <p className="font-medium text-surface-900">{profileData?.manager || 'Not specified'}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Location</p>
                  <p className="font-medium text-surface-900">{profileData?.location || 'Not specified'}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Probation Period</p>
                  <p className="font-medium text-surface-900">{profileData?.probationPeriod || 'Not specified'}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Notice Period</p>
                  <p className="font-medium text-surface-900">{profileData?.noticePeriod || 'Not specified'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-transparent shadow-soft bg-white">
            <CardHeader className="border-b border-surface-100 pb-4">
              <CardTitle className="text-lg flex items-center gap-2 text-surface-900">
                <Phone size={18} className="text-brand-500" /> Contact Details
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Official Email</p>
                  <p className="font-medium text-surface-900">{email}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Official Phone</p>
                  <p className="font-medium text-surface-900">{profileData?.phone || 'Not provided'}</p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Emergency Contact</p>
                  <p className="font-medium text-surface-900">
                    {profileData?.emergencyContactName || 'Not provided'} 
                    {profileData?.emergencyContactPhone ? ` (${profileData.emergencyContactPhone})` : ''}
                  </p>
                </div>
                <div>
                  <p className="text-xs font-semibold text-surface-500 uppercase tracking-wider mb-1">Emergency Email</p>
                  <p className="font-medium text-surface-900">{profileData?.emergencyContactEmail || 'Not provided'}</p>
                </div>
              </div>
            </CardContent>
          </Card>
